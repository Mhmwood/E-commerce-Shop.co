    ...
    <div className="px-8 py-7 border-2 rounded-3xl h-full  md:w-full min-w-[250px] ">
      ...
      <div className="">
        <div className="mb-3 flex items-center">
          <h5 className="text-xl font-bold  mr-1 whitespace-nowrap">{reviewerName}.</h5>
          <svg
            width="24"
            height="25"
            viewBox="0 0 24 25"
        ...
        <p className="font-extralight text-gray-400">"{comment}"</p>
      </div>
    </div>
  );
};

export default CardCustomersReviews;
